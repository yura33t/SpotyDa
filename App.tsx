    ...
    <div className="flex flex-col h-screen bg-black text-white overflow-hidden">
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 h-[72px] bg-black/95 backdrop-blur-xl border-t border-white/5 flex items-center justify-around z-[60] px-6 pb-[env(safe-area-inset-bottom)]">
        <button 
          ...
          className={`flex flex-col items-center justify-center w-16 h-full transition-all active:scale-90 ${currentSection === AppSection.HOME ? 'text-white' : 'text-gray-500'}`}
        >
        ...
        <button 
          ...
          className={`flex flex-col items-center justify-center w-16 h-full transition-all active:scale-90 ${currentSection === AppSection.SEARCH ? 'text-white' : 'text-gray-500'}`}
        >
        ...
        <button 
          ...
          className={`flex flex-col items-center justify-center w-16 h-full transition-all active:scale-90 ${currentSection === AppSection.LIBRARY ? 'text-white' : 'text-gray-500'}`}
        >
