  ...
  return (
    <div className="flex flex-col h-screen bg-black text-white overflow-hidden select-none">
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 h-[72px] bg-black/95 backdrop-blur-xl border-t border-white/5 flex items-center justify-around z-[60] px-6 pb-[env(safe-area-inset-bottom)]">
        <button onClick={() => setCurrentSection(AppSection.HOME)} className={`flex flex-col items-center justify-center w-16 h-full transition-colors ${currentSection === AppSection.HOME ? 'text-white' : 'text-gray-500'}`}>
        ...
        <button onClick={() => setCurrentSection(AppSection.SEARCH)} className={`flex flex-col items-center justify-center w-16 h-full transition-colors ${currentSection === AppSection.SEARCH ? 'text-white' : 'text-gray-500'}`}>
        ...
        <button onClick={() => setCurrentSection(AppSection.LIBRARY)} className={`flex flex-col items-center justify-center w-16 h-full transition-colors ${currentSection === AppSection.LIBRARY ? 'text-white' : 'text-gray-500'}`}>
